...
//       <div className="flex flex-col h-screen items-center justify-center p-8 overflow-y-auto">
     
//       <div className="mt-20">
//         <h1 className="text-center text-black text-3xl font-bold m-3 mt-15 mb-8">
           
//           Introducing Pro-Track: Empowering TTP Students at Brooklyn College
//         </h1>

//         <div className="space-y-4 text-black m-20 text-lg"  >
//         <img
//           src={brooklyncollege}
//           alt="Brooklyn College"
//           className=" w-40 h-auto absolute top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
//           />
...
//             better connections between students and educators. Pro-Track provides
//             a seamless platform for communication and collaboration, streamlining
//             assignment submissions, grades tracking, and class announcements.
//           </p>
//           <p>
//             The Technology Talent Pipeline (TTP) program equips students with
//             skills, knowledge, and real-world experience to excel in tech fields.
//             With industry-driven curriculum and partnerships with leading tech
//             companies, students gain a competitive edge in the job market. TTP
//             prepares students for success in the rapidly evolving tech industry,
//             setting them on a path to excellence upon graduation.
//           </p>
//           <p>
  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center p-8">
        ...
        <h1 className="text-center text-black text-4xl font-bold my-8">
          Introducing Pro-Track: Empowering TTP Students at Brooklyn College
        </h1>

        <div className="space-y-6 text-black max-w-3xl">
          <img
            src={brooklynCollege}
            alt="Brooklyn College"
      ...
      <footer className="bg-gray-100 py-4 text-gray-700 text-center">
